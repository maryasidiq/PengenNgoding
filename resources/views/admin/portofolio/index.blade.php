    ...
    <div class="container-fluid">
        <form method="GET" action="{{ route('admin.portofolio.index') }}" class="mb-4">
            <div class="input-group">
                <input type="text" name="search" class="form-control" placeholder="Cari portofolio..."
        ...
        <div>
            <a href="{{ route('admin.portofolio.create') }}" class="btn btn-primary mb-3">
                <i class="fas fa-plus me-2"></i> Portofolio Baru
            </a>
        </div>
            ...
            <div class="card mb-4 shadow-sm">
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-9">:
                            {{ $portofolio->dibuat_pada ? \Carbon\Carbon::parse($portofolio->dibuat_pada)->format('d/m/Y') : '-' }}
                        </div>
                    </div>
                    <div class="row mb-2">
                        ...
                        <div class="col-md-9 d-flex flex-wrap gap-2">
                            @foreach($portofolio->screenshots as $screenshot)
                                <img src="{{ filter_var($screenshot->screenshot, FILTER_VALIDATE_URL) ? $screenshot->screenshot : asset('storage/' . $screenshot->screenshot) }}"
                                    alt="Screenshot" style="width: 100px; height: 100px; object-fit: cover; border-radius: 6px;">
                            @endforeach
                        </div>
                    </div>
